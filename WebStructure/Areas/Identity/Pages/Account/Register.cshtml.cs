...
namespace WebStructure.Admin.Areas.Identity.Pages.Account
{
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _userManager.AddToRoleAsync(user, IdentityConstant.User);
                    ...
                    var emailSender = new EmailModel
                    {

                        UserEmail = Input.Email,
                        EmailSubject = "Confirm your email",
                        EmailBody = _emailSender.GenerateWelcomeEmail(Input.Email, callbackUrl),
                        UserName = Input.Email,
                    };

                    await _emailSender.SendMailAsync(emailSender);
